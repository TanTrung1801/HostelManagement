<%-- 
    Document   : tenant_memberlist
    Created on : Jul 8, 2022, 5:38:49 PM
    Author     : zeddr
--%>
    ...
    <div class="main">
        ...
        <nav id="menu">
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">My
                        Hostels</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="#hostel1" data-toggle="collapse" aria-expanded="false"
                                class="dropdown-toggle">Hostel 1</a>
                            <ul class="collapse list-unstyled" id="hostel1">
                                <li>
                                    <a href="#room1" data-toggle="collapse" 
                                    class="dropdown-toggle">Room 1</a>
                                    <ul class="collapse list-unstyled" id="room1">
                                        <li>
                                            <a href="#room1" data-toggle="collapse" 
                                    class="dropdown-toggle">Member List</a>
                                        </li>
                        ...
                        <li>
                            <a href="#hostel2" data-toggle="collapse" aria-expanded="false"
                                class="dropdown-toggle">Hostel 2</a>
                            <ul class="collapse list-unstyled" id="hostel2">
                                <li>
                                    <a href="#">Room 4</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#hostel3" data-toggle="collapse" aria-expanded="false"
                                class="dropdown-toggle">Hostel 3</a>
                            <ul class="collapse list-unstyled" id="hostel3">
                                <li>
                                    <a href="#">Room 7</a>
                                </li>
                                <li>
        ...
        <div id="content">
            ...
            <div class="row">
                <ol class="col-12 breadcrumb">
                    ...
                    <li class="breadcrumb-item">My Hostel</li>
                    <li class="breadcrumb-item ">Hostel 1</li>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="member-card pt-2 pb-2">
                            <div class="thumb-lg member-thumb mx-auto"><img src="${pageContext.request.contextPath}/img/" class="rounded-circle img-thumbnail" alt="profile-image"></div>
                            <div class="">
                                <h4>${AccountObj.fullname}</h4>
                                <p class="text-muted">${AccountObj.email} <span><a href="#" class="text-pink"></a></span></p>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="member-card pt-2 pb-2">
                            ...
                            <div class="">
                                <h4>${AccountObj.fullname}</h4>
                                <p class="text-muted">${AccountObj.email} <span>| </span></p>
                            </div>
                            <ul class="social-links list-inline">
                                <li class="list-inline-item"><a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="Facebook"><i class="fab fa-facebook"></i></a></li>
                                <li class="list-inline-item"><a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="Twitter"><i class="fab fa-twitter"></i></a></li>
