...
public class hostelController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (splitter.length == 4) {
            ...
            //query database để lấy ra 1 hostel
            ...
            switch (splitter[5]) {
                ...
                case "hostel-details":
                    ...
                    request.setAttribute("details", hostel);
                    session.setAttribute("hostel_id", hostel.getHostelId());
                    System.out.println("hostel details:" + hostel.toString());
