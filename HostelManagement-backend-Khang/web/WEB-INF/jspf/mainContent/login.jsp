<%-- 
    Document   : login
    Created on : Jun 23, 2022, 10:04:53 PM
    Author     : lekha
--%>
            ...
            <div class=" d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-sm-1 form-login">
                    <form method="POST" action="#" class="register-form"
                          id="login-form">
                        <a class="navbar-brand auth-logo " href="${pageContext.request.contextPath}">
                            <img src="${pageContext.request.contextPath}/img/HomeCity.png" height="50" width="50"><span>Hostel</span>City
                        </a>

                        <!-- Email input -->
                        <div class="form-group mb-4">
                            <label class="form-label" for="user-login">Your Username, email or phone number</label>
