...
<div class="authentication" style="background-image: url('/HostelManagement_main/img/sign-in.jpg');">
        ...
        <div class="container-fluid">
            <div class=" d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5">
                    <img src="/HostelManagement_main/img/sign-in.png" class="img-fluid" alt="Sample image">
                </div>
                <div class="col-md-8 col-lg-6 col-xl-4 offset-sm-1 form-login">
                    <form method="POST" action="/HostelManagement_main/login/submit" class="register-form"
                          id="login-form">
                        <a class="navbar-brand auth-logo " href="/HostelManagement_main/"><img src="/HostelManagement_main/img/HomeCity.png"
                        ...
                        <div class="text-center text-lg-start mt-2 pt-2">
                            <a class="google-login btn btn-lg btn-success " style="background-color: white; color:#303030;"
                               ...
                               &amp;client_id=292534222114-c67cd7kucbrqlgpkvf02g68i64pisibc.apps.googleusercontent.com&amp;approval_prompt=force"><img
                                    src="/HostelManagement_main/img/1534129544.png" height="20" width="20"> Sign in with google</a>

                        </div>


                        <p class=" fw-bold mt-5 pt-1 mb-0">Don't have an account? <a href="/HostelManagement_main/register" style="color: green; font-style:italic; " >Register</a></p>
                    </form>
                </div>
            </div>
        </div>
