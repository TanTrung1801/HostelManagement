...
//                (?=.*\d) -- check one digit exists
                ...
                String[] indexNames = {"username"};
                if (AccountDAO.getAccount(indexNames, username) != null) {
                    check = false;
                ...
                indexNames[0] = "email";
                if (AccountDAO.getAccount(indexNames, email) != null) {
                    check = false;
                ...
                indexNames[0] = "phone";
                if (AccountDAO.getAccount(indexNames, phone) != null) {
                    check = false;
                ...
                indexNames[0] = "id_card_number";
                if (AccountDAO.getAccount(indexNames, idCardNumber) != null) {
                    check = false;
            ...
            if(check){
                ...
                System.out.println(AccountDAO.addAccount(username, hashedPassword, role, firstname, lastname, email, phone, idCardNumber, status, dateOfBirth));
