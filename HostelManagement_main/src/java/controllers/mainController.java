...
//            }
            ...
            if (!path.contains("/css") && !path.contains("/fonts") && !path.contains("/images") && !path.contains("/js") && !path.contains("/vendor")) {
                ...
                if (splitter.length < 3) {
                    ...
                    String processingPath = splitter[2];
                    ...
                    for (int i = 1; i < (splitter.length - 2); i++) {
                        url = "../" + url;
                    }
                    System.out.println(url);
                    request.getRequestDispatcher(url).forward(request, response);
                    System.out.println("jhsdfjsfjhsd");
                    return;
                }
            }
   
//            url=path.substring(path.lastIndexOf("/")+1);
//            if (url.isEmpty() || url==null) url="index.jsp";
//            if (!url.contains(".")) url=url+"Servlet";
//            
