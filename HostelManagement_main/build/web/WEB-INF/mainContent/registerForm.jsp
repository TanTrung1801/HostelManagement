...
<div class="authentication" style="background-image: url('/HostelManagement_main/img/sign-up.jpg');">
        ...
        <div class="container-fluid">
            <div class=" d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5 form-register">
                    <form method="POST" action="/HostelManagement_main/register/submit" class="register-form"
                          id="register-form">
                        ...
                        <p class=" mt-5 pt-1 mb-0">Adready have account? <a href="/HostelManagement_main/login"
