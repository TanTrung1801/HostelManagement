...
public class sendEmailVerificationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            message.setSubject("Verify Email at HostelCity!");

            String token = StringUtil.generateNewToken();
            
            UpdateTokenDAO updateTokenDao = new UpdateTokenDAO();
            UpdateToken updateToken = new UpdateToken(token, accountId, 60*5, "email");
