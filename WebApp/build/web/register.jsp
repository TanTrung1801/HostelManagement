...
<html>
    ...
    <body>
        ...
        <form action="MainController" method="POST">
            ...
            Email </br>
                <input type ="email" name="email" required="" placeholder="Input your email" pattern="[a-z0-9._%+-]+@(gmail.com|fpt.edu.vn|yahoo.com)" title="Email addresses must start with a lowercase letter and end with domains '@gmail.com' or '@fpt.edu.vn'"></br>
<!--            Role </br>
